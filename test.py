...
from project.torch_utils import *
...
def test(
    ...
    # Get dataloader
    # dataloader = torch.project.data.DataLoader(LoadImagesAndLabels(test_path), batch_size=batch_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-cfg', type=str, default='data/yolo.data', help='coco.data file path')
